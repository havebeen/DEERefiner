function contactedResidueIndex = formatedPDB2contactedResidueNumbers(formatedPDB, contactCriterion)
    ...
    for i = 1:length(residueIndex)
        ...
        ignoredPairDistance(double(formatedPDB(:, 7)) == (residueIndex(i)) & formatedPDB(:, 3) == " CB ",...
            double(formatedPDB(:, 7)) == (residueIndex(i)) & (formatedPDB(:, 3) == " CG1" |formatedPDB(:, 3) == " CG2"|formatedPDB(:, 3) == " CG "|formatedPDB(:, 3) == " OG "|formatedPDB(:, 3) == " OG1"|formatedPDB(:, 3) == " SG "|...
        ...
        ignoredPairDistance(double(formatedPDB(:, 7)) == (residueIndex(i)) & formatedPDB(:, 3) == " CA ",...
        ...
        ignoredPairDistance(double(formatedPDB(:, 7)) == (residueIndex(i)) & formatedPDB(:, 3) == " O  ", :) = NaN;
    end
